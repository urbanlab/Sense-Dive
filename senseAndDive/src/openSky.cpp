...
void openSky::setup() {
    ...
    for (int i=0; i<NB_BGND_ELEMENTS; i++) {
        createNewParticule(ofRandom(xMin, xMax), ofRandom(yMin, yMax));//ofGetWidth()/2, ofGetHeight()/2);
    }
...
//--------------------------------------------------------------
void openSky::scanMediasDir(string path)
{
    ofDirectory dir;
    dir.allowExt("png");
...
//--------------------------------------------------------------
void openSky::loadMedias(int it)
{
    //scan directories
    basePath = "medias";
    iterator = it;
...
//--------------------------------------------------------------
void openSky::keyPressed(int key) {
...
//--------------------------------------------------------------
void openSky::createNewParticule(float x, float y)
{
